...
namespace Palatium.Clases
{
    class ClaseReportes
    {
        ...
        public string encabezadoReporte(string sFecha_P, int iIdLocalidad_P, int iIdJornada_P)
        {
            try
            {
                ...
                sSql += "where id_jornada = " + iIdJornada + Environment.NewLine;
                sSql += "and id_localidad = " + iIdLocalidad + Environment.NewLine;
                sSql += "and fecha_apertura = '" + sFecha + "'";
        ...
        public string resumenSistema(string sFecha_P, int iIdLocalidad_P, int iIdJornada_P)
        {
            try
            {
                this.sFecha = sFecha_P;
                ...
                for (int i = 0; i < dtAyuda.Rows.Count; i++)
                {
                    ...
                    if (iCuenta > 0)
                    {
                        ...
                        sTexto += sOrigenOrden.PadRight(22, ' ') + iCuenta.ToString("N0").PadLeft(5, ' ') + sTotal.PadLeft(13, ' ') + Environment.NewLine;
                    }
                }
        ...
        public string pagosPrioritarios(string sFecha_P, int iIdLocalidad_P, int iIdJornada_P)
        {
            try
            {
                this.sFecha = sFecha_P;
        ...
        public string productosDespachados(string sFecha_P, int iIdLocalidad_P, int iIdJornada_P)
        {
            try
            {
                this.sFecha = sFecha_P;
                ...
                for (int i = 0; i < dtAyuda.Rows.Count; i++)
                {
                    ...
                    sSql += "and CAB.id_pos_jornada = " + iIdJornada + Environment.NewLine;
        ...
        public string reporteCantidadPagos(string sFecha_P, int iIdLocalidad_P, int iIdJornada_P)
        {
            try
            {
                this.sFecha = sFecha_P;
        ...
        private void llenarCuentasCanceladas()
        {
            try
            {
                ...
                sSql += "and CP.id_localidad = " + iIdLocalidad + Environment.NewLine;
                sSql += "and CP.id_pos_jornada = " + iIdJornada;
        ...
        public string arqueoCaja(string sFecha_P, int iIdLocalidad_P, int iIdJornada_P)
        {
            try
            {
                this.sFecha = sFecha_P;
            ...
            try
            {
                ...
                if (bRespuesta == true)
                {
                    if (dtConsulta.Rows.Count != 0)
                    {
                        if (dtConsulta.Rows.Count == 1)
                        {
                            sTexto = sTexto + "N. Entrega desde: " + dtConsulta.Rows[0][0].ToString().PadLeft(8, ' ') + "  hasta: " + dtConsulta.Rows[0][0].ToString().PadLeft(7, ' ') + Environment.NewLine;
                        }

                        else if (dtConsulta.Rows.Count > 1)
                        {
                            sTexto = sTexto + "N. Entrega desde: " + dtConsulta.Rows[0][0].ToString().PadLeft(8, ' ') + "  hasta: " + dtConsulta.Rows[1][0].ToString().PadLeft(7, ' ') + Environment.NewLine;
                        }
                    }
                }
                ...
                {
                    sTexto = sTexto + "N. Entrega desde: " + "".PadLeft(8, ' ') + "   hasta:" + "".PadLeft(8, ' ') + Environment.NewLine;
                }
            }
        ...
        public string ventasMesero(string sFecha_P, int iIdLocalidad_P, int iIdJornada_P)
        {
            try
            {
                this.sFecha = sFecha_P;
        ...
        public string llenarMovimientosAgrupados(int iTipoMovimiento, string sFecha_P, int iIdLocalidad_P, int iIdJornada_P)
        {
            try
            {
                this.sFecha = sFecha_P;
        ...
        public string ahorroEmergencia(string sFecha_P, int iIdLocalidad_P, int iIdJornada_P, Decimal dbAhorroEmergencia_P)
        {
            try
            {
                this.sFecha = sFecha_P;
        ...
        public string contarMonedas(int iIdCierreCajero_P, int iIdLocalidad_P, int iIdJornada_P, Decimal dbCajaInicial_P, Decimal dbCajaFinal_P)
        {
            try
            {
                this.iIdLocalidad = iIdLocalidad_P;
