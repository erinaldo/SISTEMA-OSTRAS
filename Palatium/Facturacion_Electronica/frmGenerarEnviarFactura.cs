    ...
    public partial class frmGenerarEnviarFactura : Form
    {
        ...
        private void LLenarComboLocalidad()
        {
            try
            {
                ...
                {
                    cmbLocalidad.SelectedIndex = Program.iIdLocalidad;
                }
            }
        ...
        private void llenarGrid()
        {
            try
            {
                ...
                sSql += "isnull(F.correo_electronico, '" + Program.sCorreoElectronicoDefault.Trim().ToLower() + "') correo_electronico" + Environment.NewLine;
                ...
                sSql += "and F.id_tipo_ambiente = " + sIdTipoAmbiente;
