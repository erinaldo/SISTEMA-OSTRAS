...
namespace Palatium.Oficina
{
    public partial class frmIngresoMasivoPersonal : Form
    {
        ...
        private void recuperarSecuencia()
        {
            ...
            {
                sSql = "";
                sSql += "select isnull(secuencia_codigo, 1) secuencia_codigo" + Environment.NewLine;
        ...
        private void insertarRegistros()
        {
            try
            {
                ...
                for (int i = 0; i < dgvDatos.Rows.Count; i++)
                {
                    ...
                    sSql += "'" + sIdentificacion + "', '" + sApellidos + "', '" + sNombres + "'," + Environment.NewLine;
                ...
                sSql += "secuencia_codigo = " + iSecuencia + Environment.NewLine;
                sSql += "where id_localidad = " + Program.iIdLocalidad + Environment.NewLine;
                sSql += "and estado = 'A'";
