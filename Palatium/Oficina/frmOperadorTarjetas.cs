...
namespace Palatium.Oficina
{
    public partial class frmOperadorTarjetas : MaterialForm
    {
        ...
        private void llenarGrid(int iOp)
        {
            ...
            {
                sSql = "";
                sSql = sSql + "select id_pos_operador_tarjeta as 'ID', codigo as CÓDIGO, descripcion as DESCRIPCION," + Environment.NewLine;
                sSql = sSql + "case estado when 'A' then 'ACTIVO' else 'INACTIVO' end as ESTADO" + Environment.NewLine;
                sSql = sSql + "from pos_operador_tarjeta" + Environment.NewLine;
                ...
                sSql = sSql + "order by id_pos_operador_tarjeta";
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql = sSql + "insert into pos_operador_tarjeta (" + Environment.NewLine;
        ...
        private void actualizarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql = sSql + "update pos_operador_tarjeta set" + Environment.NewLine;
                sSql = sSql + "descripcion = '" + txtDescripcion.Text.Trim() + "'" + Environment.NewLine;
                sSql = sSql + "where id_pos_operador_tarjeta = " + iIdRegistro + Environment.NewLine;
        ...
        private void eliminarRegistro()
        {
            try
            {
                ...
                sSql = sSql + "where id_pos_operador_tarjeta = " + iIdRegistro;
