...
{
    public partial class frmVerMovimientosAgrupados : Form
    {
        ...
        public frmVerMovimientosAgrupados(int iTipoMovimiento, string sFecha, int iCerrar)
        {
        ...
        private void verMovimientoTextBox()
        {
            try
            {
                sRetorno = movimiento.llenarMovimientosAgrupados(iTipoMovimiento, sFecha);
        ...
        private void frmVerMovimientosAgrupados_Load(object sender, EventArgs e)
        {
            verMovimientoTextBox();
            this.ActiveControl = lblRecibir;
        }

        private void frmVerMovimientosAgrupados_KeyDown(object sender, KeyEventArgs e)
        {
