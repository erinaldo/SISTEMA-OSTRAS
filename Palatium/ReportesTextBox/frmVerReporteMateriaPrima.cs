...
{
    public partial class frmVerReporteMateriaPrima : Form
    {
        ...
        Clases.ClaseReporteMateriaPrima reporte = new Clases.ClaseReporteMateriaPrima();
        ...
        private void verMateriaPrimaTextBox()
        {
            try
            {
        ...
        private void frmVerReporteMateriaPrima_Load(object sender, EventArgs e)
        {
            verMateriaPrimaTextBox();
            this.ActiveControl = lblRecibir;
        }

        private void frmVerReporteMateriaPrima_KeyDown(object sender, KeyEventArgs e)
        {
